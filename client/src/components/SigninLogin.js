...
const apiAuthenticateUser = async (email, password) => {
    try {
...
const SignInLogin = () => {
	...
	const handleSignIn = async (e) => {
		...
		if (response && response.error) {
		  ...
		  console.error("Unexpected response from apiAuthenticateUser:", response);
		}
	  }
                ...
                <div className="container" id="container">
                    ...
                    <div className="form-container sign-in-container">
                        <form onSubmit={handleSignIn}>
                            ...
                            {signInSuccess && <p style={{ color: 'green' }}>Successfully signed in!</p>}
                            {signInError && <p style={{ color: 'red' }}>Incorrect password or username</p>}
                        </form>
                    </div>
